...
<body class="bg-light">
    <div class="container mt-5">
        <div class="card shadow p-4">
            ...
            <h4 class="text-center mb-4">Update Data Buku</h4>
            <form method="POST" action="{{route('buku.update', $buku->id)}}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="penulis" value="{{$buku->penulis}}" id="penulis">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    value="{{$buku->tgl_terbit}}" id="tgl_terbit">
                </div>
